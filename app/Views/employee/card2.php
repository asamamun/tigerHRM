...
//    START Generate EMP CARD info
    ...
    <section class="d-flex justify-content-center mt-5 me-5">
        ...
        <div class="border border-2 me-2 roumded" id="page1-div" style="position:relative;width:355px;height:219px;">
    ...
    <?= anchor('employee/card/' . $employee ['id'], 'Card PDF', ['class' => 'btn btn-info rounded mx-1']); ?>
    <a href="<?php echo base_url('employee/card/' . $employee ['id'], 'Card PDF',['class' => 'btn btn-info rounded mx-1']) ?>" class="btn btn-primary">
        Download PDF
      </a>
