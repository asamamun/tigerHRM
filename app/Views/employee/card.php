...
//    START Generate EMP CARD info
    ...
    <section class="d-flex justify-content-center mt-5 me-5">
        <!-- START EMP ID Frame  -->	
        ...
        <div class="border border-2 roumded" id="page1-div" style="position:relative;width:355px;height:219px;">
            ...
            <p style="position:absolute;top:73px;left:19px;white-space:nowrap" class=""><b>Name:&#160;&#160;</b><?php echo $employee['fname'] . " " . $employee['lname']; ?></p>
            ...
            <p style="position:absolute;top:93px;left:19px;white-space:nowrap" class=""><b>Designation:&#160;</b><?php echo $designame ?></p>
            <p style="position:absolute;top:112px;left:19px;white-space:nowrap" class=""><b>Emp&#160;ID:&#160;</b><?php echo str_pad($employee['empid'], 8, "0", STR_PAD_LEFT); ?></p>
            <p style="position:absolute;top:132px;left:19px;white-space:nowrap" class=""><b>Dept:&#160;</b><?php echo $deptname ?></p>
            <p style="position:absolute;top:151px;left:19px;white-space:nowrap" class=""><b>Issued&#160;Date:&#160;</b><?php echo date("F j, Y"); ?></p>
        ...
        <div class="border border-2 roumded ms-2 bg-light" id="page1-div" style="position:relative;width:355px;height:219px;">
            <img width="352" height="217" src="<?php echo site_url().'/assets/images/card/CardTemplate-back.png' ?>" alt="background image"/>
            <img style="position:absolute;top:58px;left:244px;white-space:nowrap; padding:2px; background:white; border-radius:5px" width="85px" height="95px" src="<?= $qrcode2 ?>" alt='QR Code'/>
            ...
            <p style="position:absolute;top:93px;left:19px;white-space:nowrap" class="small"><span><i class="fa-solid fa-house"></i>&#160;</span><?php echo $employee['dob']; ?></p>
            ...
            <p style="position:absolute;top:15px;left:244px;white-space:nowrap" class=" text-primary text-uppercase"><b><?php echo $company['companyname']; ?></b></p>
            <!-- <p style="position:absolute;top:15px;left:51px;white-space:nowrap" class="text-info text-uppercase"><b><?php //echo $company['companyname']; ?></b></p> -->
            <!-- <p style="position:absolute;top:35px;left:51px;white-space:nowrap" class="text-muted">with the best policy</p> -->
