                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?= base_url() ?>/tiger/settings">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Settings
                            </a>
                            ...
                            <div class="collapse" id="OrganLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/department">Department</a>
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/designation">Designation</a>
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/section">Section</a>
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/grade">Grade</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="EmployeeLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/employee">Employee Details</Details></a>
                               </nav>
                            </div>
                            ...
                            <div class="collapse" id="AttendanceLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/attendance/attendancelist">Attendance list</a>
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/attendance/addattendance">Add Attendance</a>
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/attendance/report">Attendance Report</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="lvLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/leave">Leave Manage</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#noticerout" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-align-justify"></i></div>
                                Notice

                            </a>
                            <div class="collapse" id="noticerout" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= base_url() ?>/tiger/notice">Notice Board</a>
                                </nav>
                            </div>
