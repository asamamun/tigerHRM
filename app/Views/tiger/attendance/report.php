            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-info"><a href="<?php echo base_url(''); ?>/tiger/attendance/addattendance" class="text-white"><i class="" aria-hidden="true"></i> Attendance List </a></button>
                    </div>
                </div>  
                <div class="row">
                    <div class="col-12">
