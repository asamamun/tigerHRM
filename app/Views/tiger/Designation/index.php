...
<?= view("tiger/partial/flashmessage"); ?>
    ...
    <div class="container mb-1">
                ...
                <div class="card rounded">
                    <div class="card-body">
                        ...
                        <div class="col-sm-2">
                             ...
                             <a href="<?= base_url('/tiger/designation/add')?>"class="btn btn-success float-left" >Add Designation</a>
        ...
        <?= anchor('tiger/designation/edit/'.$des['id'],'Edit',['class' => 'btn btn-primary rounded mx-1']); ?>
                                        <td class="text-center">
                                            <!-- <a href="#" class="btn btn-primary rounded mx-1">Edit</a> -->
                                            <a href="<?=base_url('tiger/designation/delete/'.$des['id'])?>" class="btn btn-danger rounded mx-1">Delete</a>
                                        </td>
                        </tr>
                        <?php
                    }?>
